function onCreate()
	-- background shit
	makeLuaSprite('sky', 'StageTails/SKY', -600, -100);
	setScrollFactor('sky', 0.9, 0.9);
	
	makeLuaSprite('floor1', 'StageTails/FLOOR2', -650, 0);
	setScrollFactor('floor1', 0.9, 0.9);
	scaleObject('floor1', 1.1, 1.1);

	makeLuaSprite('floor2', 'StageTails/FLOOR1', -650, 0);
	setScrollFactor('floor2', 0.9, 0.9);
	scaleObject('floor2', 1.1, 1.1);

	makeLuaSprite('grass', 'StageTails/frontgrass', -650, 0);
